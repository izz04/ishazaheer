...
(function(){
    ...
    function Paper( x, y, angle, size, progress ) {
        ...
        this.size = size * 0.5;
        this.fold = this.size;
        this.colorA = new HSL(330, 100, 70).randomize(); // Pink color
        this.colorB = new HSL(330, 100, 50).randomize(); // Light pink color
    ...
    function HSL( h, s, l ) {
        ...
        this.randomize = function() {
            this.h = 330; // Set hue to pink (330)
            this.s = 80 + Math.random()*20; // Randomize saturation for variety
            this.l = 50 + Math.random()*20; // Randomize lightness for variety
